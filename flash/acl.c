...
fprintf(stderr, "---%d : %d : %s\n", data[0], l4->req->l, data);
	...
	//if (strncasecmp((const char *)data, "<policy-file-request/>\0", 23) != 0)
	if (strncasecmp((const char *)data, "</>", 3) != 0)
		goto not_policy;
...
//DVV
	{ "req_flash_policy",    acl_parse_str,        acl_fetch_flash_policy,   acl_match_nothing, ACL_USE_L6REQ_VOLATILE|ACL_MAY_LOOKUP },
//DVV
#if 0
